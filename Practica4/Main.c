...
int main()
{
  ...
  //Guardar matriz en la memoria compartida
   ...
   while(resultados[0]==1 || resultados[1]==2 || resultados[2]==3); //Espera hasta que todos los resultados se registren
   
   if(resultados[0]!=1 && resultados[1]!=2 && resultados[2]!=3) //Evalua si ya se registraron todos los resultados de las sumas
   {
    for(i=0;i<3;i++)
     {
